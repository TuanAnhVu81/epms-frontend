            ...
            >
                ...
                <Form form={form} layout="vertical" scrollToFirstError>
                    <Row gutter={[16, 0]}>
                        ...
                        <Col xs={24} md={12}>
                            <Form.Item name="taxId" label="Mã số thuế (Tax ID)" rules={[{ required: true, message: 'Vui lòng nhập Mã số thuế' }]}>
                        ...
                        <Col xs={24}>
                            <Divider orientation="left" plain style={{ margin: '8px 0' }}>Thông tin ngân hàng</Divider>
                        </Col>
                        ...
                        <Col xs={24} md={8}>
                            <Form.Item name="bankBranch" label="Chi nhánh">
                                <Input placeholder="Ba Đình, TP.HCM..." />
                            </Form.Item>
                        </Col>
